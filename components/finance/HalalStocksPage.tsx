...
const FMP_API_KEY = process.env.NEXT_PUBLIC_FMP_API_KEY || process.env.VITE_FMP_API_KEY;
const RAZORPAY_KEY_ID = process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID || process.env.VITE_RAZORPAY_KEY_ID;
    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto pb-32 md:pb-8 animate-fade-up">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div 
            id="tool-zakat-calc"
            onClick={() => router.push('/finance/zakat-calculator')}
